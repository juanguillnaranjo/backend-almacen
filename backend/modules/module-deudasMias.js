...
var DeudaMiaSchema = Schema({
	nombreProveedor: { type: String, required: true, trim: true, unique: true, index: true },
	tipoDeuda: { type: String, trim: true, lowercase: true, default: 'otros' },
	...
	timestamps: true,
	collection: 'deudasmias'
});

module.exports = mongoose.model('DeudaMia', DeudaMiaSchema);
